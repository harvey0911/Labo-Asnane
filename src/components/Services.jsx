...
const serviceData = [
    {
        ...
        desc: "Fixed prosthetics including ceramo-metallic and full ceramic crowns.",
        icon: (
    ...
    },
    {
        ...
        desc: "Advanced implantology solutions, total sur barre (Pilotis & D'Acker-man).",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
    ...
    {
        title: "Support CAD-CAM",
        desc: "High-precision computer-aided design and manufacturing.",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
    ...
    },
    {
        ...
        desc: "Clear aligners and functional retainers crafted for comfort.",
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
        ...
        <section id="services" className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-sm font-bold text-blue-600 tracking-widest uppercase mb-3">Core Expertise</h2>
                    <h3 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight">Comprehensive Laboratory <span className="font-light text-slate-400">Services</span></h3>
                </div>
