...
const Hero = () => {
    return (
        <section className="relative pt-12 pb-20 md:pt-20 md:pb-32 overflow-hidden bg-slate-900">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center -translate-y-12">
                ...
                <div className="w-full md:w-3/5 md:pr-12 animate-fade-in-up">
                    ...
                    <p className="text-lg md:text-xl text-slate-300 mb-10 max-w-2xl leading-relaxed">
                        Laboratoire de prothèse dentaire de pointe alliant expertise artisanale et technologie CAO-FAO. Nous concevons des restaurations prothétiques de haute précision pour sublimer chaque sourire.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4">
                        <a href="#pricing" className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-full font-bold text-lg shadow-[0_0_20px_rgba(37,99,235,0.4)] hover:shadow-[0_0_30px_rgba(37,99,235,0.6)] transition-all duration-300 text-center">
                            Découvrir les Tarifs
                        </a>
                        <a href="#contact" className="glass-dark text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-slate-800 transition-all duration-300 flex items-center justify-center gap-2">
                ...
                <div className="w-full md:w-2/5 mt-16 md:mt-0 flex justify-end translate-y-12">
                    <div className="glass-dark p-8 rounded-3xl w-full max-w-md shadow-2xl border border-slate-700/50 backdrop-blur-xl animate-[fade-in-up_1s_ease-out_0.2s_forwards] opacity-0">
                        ...
                        <h3 className="text-xl md:text-2xl font-bold text-white mb-2 leading-tight">Accès Direct au Laboratoire</h3>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-4 bg-slate-800/50 p-4 rounded-xl border border-slate-700/50">
                                <div className="text-emerald-400 font-bold bg-emerald-900/30 px-3 py-1 rounded-lg text-sm">E-MAIL</div>
                                <a href="mailto:laboasnane@gmail.com" className="text-white text-base font-medium truncate hover:text-blue-400 transition-colors">laboasnane@gmail.com</a>
                            </div>
                        </div>
                    </div>
                </div>
